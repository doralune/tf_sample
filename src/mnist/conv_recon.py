...
from conv_ae import get_xdats, Xnn
import tensorflow as tf

def init():
    parser = argparse.ArgumentParser()
    # inout
    parser.add_argument("--ckpt_file", default='out/sample/mnist/conv_ae/dummy/model/c-5999')
    parser.add_argument("--out_dir", default='out/sample/mnist/conv_recon/dummy')
